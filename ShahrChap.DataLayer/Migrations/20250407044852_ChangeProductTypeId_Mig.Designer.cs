...
namespace ShahrChap.DataLayer.Migrations
{
    ...
    [Migration("20250407044852_ChangeProductTypeId_Mig")]
    partial class ChangeProductTypeId_Mig
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShahrChap.DataLayer.Entities.Product.DesignPrice", b =>
                {
                    b.Property<int>("DesignPriceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DesignPriceId"));
            ...
            modelBuilder.Entity("ShahrChap.DataLayer.Entities.Product.Form.FormInput", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("FormInputId"));
            ...
            modelBuilder.Entity("ShahrChap.DataLayer.Entities.Product.Form.ProductForm", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ProductFormId"));
                    ...
                    b.HasKey("ProductFormId");

                    b.HasIndex("PF_TypeId");
            ...
            modelBuilder.Entity("ShahrChap.DataLayer.Entities.Product.Form.ProductFormType", b =>
                {
                    b.Property<int>("PF_TypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PF_TypeId"));
            ...
            modelBuilder.Entity("ShahrChap.DataLayer.Entities.Product.Form.FormInput", b =>
                {
                    ...
                    b.HasOne("ShahrChap.DataLayer.Entities.Product.Form.ProductForm", "ProductForm")
                        .WithMany("FormInputs")
            ...
            modelBuilder.Entity("ShahrChap.DataLayer.Entities.Product.Form.ProductForm", b =>
                {
                    b.HasOne("ShahrChap.DataLayer.Entities.Product.Form.ProductFormType", "ProductFormType")
                        .WithMany("ProductForms")
                        .HasForeignKey("PF_TypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
